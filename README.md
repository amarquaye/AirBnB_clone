...
The initial stage of a four-part project involves developing a fundamental replica of the AirBnB web application. During this first phase, a simple command-line interface was built using the Python module Cmd. The primary purpose of this interface is to handle the project's objects, enabling the implementation of essential methods such as create, show, update, all, and destroy for both the existing classes and subclasses.
...
```
$ git clone https://github.com/amarquaye/AirBnB_clone.git
```
...
* Jesse Amarquaye - @amarquaye
* Aboulfaraj Houssam - @Houssamab54
